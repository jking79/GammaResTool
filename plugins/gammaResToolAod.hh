...
class GammaResToolAod : public edm::one::EDAnalyzer<edm::one::SharedResources>  {

	public:

    	explicit GammaResToolAod(const edm::ParameterSet&);
      	~GammaResToolAod();

      	static void fillDescriptions(edm::ConfigurationDescriptions& descriptions);

		float getPhotonSeedTime( reco::Photon );
	...
	private:
        ...
        std::vector<bool>  rhRtisOOT, rhCCisOOT,rhisGS6, rhisGS1, rhisWeird, rhisDiWeird, rhisGood, rhIsUsed;
