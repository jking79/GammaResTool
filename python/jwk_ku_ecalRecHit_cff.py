...
# rechit producer
ecalRecHitBase = cms.EDProducer("EcalRecHitProducer",
    EErechitCollection = cms.string('EcalRecHitsBaseEE'),
    EEuncalibRecHitCollection = cms.InputTag("ecalMultiFitUncalibRecHit","EcalUncalibRecHitsBaseEE"),
    EBuncalibRecHitCollection = cms.InputTag("ecalMultiFitUncalibRecHit","EcalUncalibRecHitsBaseEB"),
    EBrechitCollection = cms.string('EcalRecHitsBaseEB'),
...
fastSim.toModify(ecalRecHitBase,
...
phase2_ecal_devel.toModify(ecalRecHitBase,
