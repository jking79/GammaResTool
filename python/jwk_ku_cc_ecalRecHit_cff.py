...
# rechit producer
ecalRecHitCCBase = cms.EDProducer("EcalRecHitProducer",
...
fastSim.toModify(ecalRecHitCCBase, 
...
ecal_ccrhtiming =  cms.Modifier()
ecal_ccrhtiming.toModify(ecalRecHitCCBase,
    timeCalibTag = ':CC',
    timeOffsetTag = ':CC'
)
...
gpuValidationEcal.toModify(ecalRecHitCCBase,
    timeCalibTag = ':',
    timeOffsetTag = ':'
)
...
phase2_ecal_devel.toModify(ecalRecHitCCBase,
