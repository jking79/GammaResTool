...
// Wed Mar  8 11:12:17 2023 by ROOT version 6.24/07
// from TTree llpgtree/llpgtree
// found on file: ku_KUCC_tt_R2022C_126_gammares_v10.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *rhCCTime;
   vector<float>   *rhEnergy;
   vector<bool>    *rhRtisOOT;
   vector<bool>    *rhCCisOOT;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ku_KUCC_tt_R2022C_126_gammares_v10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ku_KUCC_tt_R2022C_126_gammares_v10.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ku_KUCC_tt_R2022C_126_gammares_v10.root:/tree");
