...
// Thu Feb 23 11:56:30 2023 by ROOT version 6.24/07
// from TTree llpgtree/llpgtree
// found on file: ku_KUCC_R2018_126_gammares_v4.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<float>   *phoCovIEtaIEta;
   vector<float>   *phoCovIEtaIPhi;
   vector<float>   *phoCovIPhiIPhi;
   ...
   TBranch        *b_phoCovIEtaIEta;   //!
   TBranch        *b_phoCovIEtaIPhi;   //!
   TBranch        *b_phoCovIPhiIPhi;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ku_KUCC_R2018_126_gammares_v4.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ku_KUCC_R2018_126_gammares_v4.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ku_KUCC_R2018_126_gammares_v4.root:/tree");
...
void egammares_hist_base::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("phoCovIEtaIEta", &phoCovIEtaIEta, &b_phoCovIEtaIEta);
   fChain->SetBranchAddress("phoCovIEtaIPhi", &phoCovIEtaIPhi, &b_phoCovIEtaIPhi);
   fChain->SetBranchAddress("phoCovIPhiIPhi", &phoCovIPhiIPhi, &b_phoCovIPhiIPhi);
