...
// Tue Apr 16 09:33:49 2024 by ROOT version 6.30/03
// from TTree llpgtree/llpgtree
// found on file: ku_18A_diag_126_gammares_v10.root
//////////////////////////////////////////////////////////

#ifndef egmres_llpgtree_h
#define egmres_llpgtree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   egmres_llpgtree(TTree *tree=0);
   virtual ~egmres_llpgtree();
...
#ifdef egmres_llpgtree_cxx
egmres_llpgtree::egmres_llpgtree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ku_18A_diag_126_gammares_v10.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ku_18A_diag_126_gammares_v10.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("ku_18A_diag_126_gammares_v10.root:/tree");
...
egmres_llpgtree::~egmres_llpgtree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t egmres_llpgtree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t egmres_llpgtree::LoadTree(Long64_t entry)
{
...
void egmres_llpgtree::Init(TTree *tree)
{
...
void egmres_llpgtree::Show(Long64_t entry)
{
...
Int_t egmres_llpgtree::Cut(Long64_t entry)
{
...
#endif // #ifdef egmres_llpgtree_cxx
