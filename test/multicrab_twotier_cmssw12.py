...
def subcrab( runs, events, reqmem ):
    ...
    if options.crabCmd == 'submit':
        ...
        config.Data.unitsPerJob  =  50000 # unitsPerJob = 1000 for 321122-321128 and maxMemoryMB = 4000  on EventAwareLumiBased
        ...
        config.Data.outLFNDirBase    = '/store/user/jaking/'
        #--------------------------------------------------------
        ...
        for inDO in inputDataAndOpts:
            ...
            config.JobType.pyCfgParams   = ['globalTag=124X_dataRun3_PromptAnalysis_v1', 'outputFileName=output.root'] 
...
def submit_run():
		...
		subcrab( "352319-999999","",2500)# Run3 any
