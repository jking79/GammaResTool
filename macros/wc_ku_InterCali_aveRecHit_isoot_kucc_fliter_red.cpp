...
void wc_ku_InterCali_aveRecHit_mini( string indir, string infilelistname, string outfilename, bool filterRecHits ){
    ...
    for( auto ai = 0; ai < nAlgos; ai++ ){
         for( std::map<UInt_t,Float_t>::iterator it=(*icmaps[ai]).begin(); it!=(*icmaps[ai]).end(); ++it){
            ...
            const auto & map_time = (((*icmaps[ai])[it->first])/((*nicmaps[ai])[it->first])) + offset; 
            ...
            if( fill_idinfo.ecal == ECAL::EB ){
				...
				//if( filterRecHits ) map_time = (DetIdHists[it->first]).
...
int main ( int argc, char *argv[] ){
    ...
    //else {
        ...
        //auto infilelist = "master_list_files/egammares_MetPD_MINIAOD_Run2017E_v2_304475_califilelist.txt";
        ...
        //auto outfilename = "KURes_14011_v12_mc_ZprimeToEE_M-6000_MC_stgt_Cali.root";
        //auto outfilename = "KURes_14011_v12_MetPD_AOD_Run2017E_Cali_Filtered_304475.root";
        ...
        //auto outfilename = "KURes_14011_v12_MetPD_MINIAOD_Run2017E_v2_Cali_304475.root";
        //auto outfilename = "KURes_14011_v12_DEGPD_AOD_Run2017F_Cali_Filtered_305040_305365.root";
        auto outfilename = "KURes_14011_v12_EGMPD_MINIAOD_Run2018D_Cali_324305_327239.root";
