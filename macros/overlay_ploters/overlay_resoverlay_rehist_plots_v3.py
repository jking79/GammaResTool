...
#    legend.SetHeader(layout['legtitle'], '')
    ...
    for histname, infileb1, infile1, infile2, lego in hist_list :
...
dysdir = 'egres_DY1JetsToLL_AODSIM_R17_Cali_FilterFit_Smear_v3_ZBins_14011_v10_plots/'
dysres = 'egres_DY1JetsToLL_AODSIM_R17_FilterFit_Smear_v3_ZBins_14011_v12_resplots.root'

loc1 = resdir + degdir + degres
loc2 = resdir + dydir + dyres
loc3 = resdir + dysdir + dysres
...
if True :
  ...
  outname = 'llpa_egmres_smearres_zee'
