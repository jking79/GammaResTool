...
#    legend.SetHeader(layout['legtitle'], '')
    ...
    for histname, tree, infileb1, infile1, lego in hist_list :
        ...
        for bn in range( 0, lenmybins):
            ...
            h1[n].SetPoint(bn,binmid1,valdiff)
            ...
            h1[n].SetPointError(bn,widtherr1,err)
...
if True :
  ...
  outname = 'llpa_egmres_deg_v_dy_zee'
  ...
  #    [ rhname1, "", base1-sig, base2-bkgrd, rfgmsbroc1-sig, rfgmsbroc2-bkgrd, rhname1, cut1, usebase1 ],
      [ rhname1, "", degdir+degres, dydir+dyres, 'Diff DEG v DY ZEE' ],
